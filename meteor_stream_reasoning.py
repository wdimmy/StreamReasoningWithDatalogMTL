...
output_file_handler = logging.FileHandler("./meteor_mock.log")
...
logger.info("============Stream Reasoning Starts（MeTeoR) ============\n")
...
for streams, t_next in stream_generator.generator():
    ...
    new_area = Interval(min_val, t_next, False, False)
