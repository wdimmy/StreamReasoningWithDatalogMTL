...
We put in the **programs** folder the three programs we used in our experiments, where short_stop.txt, meteor_nonrecursive.txt
and meteor_recursive.txt correspond to \Prog, \Prog_{nr} and \Prog_{r} in the paper. 
...
can download them in this publicly available [link](https://drive.google.com/file/d/1sLngq8NFpNRKQcfJqXnqTVlLCcdOBZeK/view?usp=share_link).
...
(**NOTE** that you need to download LUBM datasets [link](https://drive.google.com/file/d/1sLngq8NFpNRKQcfJqXnqTVlLCcdOBZeK/view?usp=share_link) and unzip into datasets folder first if you want to run the LUBM experiments.)
